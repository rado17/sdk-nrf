...
static int instance_set(const struct shell *shell, const struct bt_mesh_model **mod, uint16_t mod_id,
...
int shell_model_instance_set(const struct shell *shell, const struct bt_mesh_model **mod, uint16_t mod_id,
			     uint8_t elem_idx)
{
